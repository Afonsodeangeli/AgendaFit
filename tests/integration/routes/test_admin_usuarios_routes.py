...
class TestListarUsuarios:
    ...
    def test_listar_usuarios_requer_admin(self, aluno_autenticado):
        """Aluno não deve acessar listagem de usuários"""
...
class TestCadastrarUsuario:
    ...
    def test_get_cadastrar_requer_admin(self, aluno_autenticado):
        """Aluno não deve acessar formulário de cadastro"""
        response = aluno_autenticado.get(
    ...
    def test_cadastrar_usuario_com_perfil_professor(self, admin_autenticado):
        """Admin deve poder cadastrar professor"""
        response = admin_autenticado.post(
            "/admin/usuarios/cadastrar",
            data={
                "nome": "Novo Professor",
                "email": "novoprofessor@example.com",
                "senha": "SenhaProfessor@123",
        ...
        usuario = usuario_repo.obter_por_email("novoprofessor@example.com")
        assert usuario is not None
...
class TestEditarUsuario:
    ...
    def test_get_editar_requer_admin(self, aluno_autenticado, criar_usuario):
        """Aluno não deve acessar formulário de edição"""
        ...
        # Aluno pode receber 200 mas sem permissão, ou redirect/403
...
class TestExcluirUsuario:
    ...
    def test_aluno_nao_pode_excluir_usuario(self, aluno_autenticado, criar_usuario):
        """Aluno não deve poder excluir usuários"""
        criar_usuario("Outro Usuario", "outro@example.com", "Senha@123")
...
class TestAdminUsuariosRateLimiting:
    ...
    def test_cadastrar_rate_limit(self, admin_autenticado):
        ...
        with patch(
            "routes.admin_usuarios_routes.admin_usuarios_limiter.verificar",
            return_value=False,
        ):
            response = admin_autenticado.post(
                "/admin/usuarios/cadastrar",
