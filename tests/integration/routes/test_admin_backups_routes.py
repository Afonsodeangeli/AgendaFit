...
class TestListarBackups:
    ...
    def test_professor_nao_acessa_listagem(self, professor_autenticado):
        ...
        response = professor_autenticado.get("/admin/backups/listar", follow_redirects=False)
        assert response.status_code in [status.HTTP_303_SEE_OTHER, status.HTTP_403_FORBIDDEN]
...
class TestCriarBackup:
    ...
    def test_professor_nao_pode_criar_backup(self, professor_autenticado):
        ...
        response = professor_autenticado.post("/admin/backups/criar", follow_redirects=False)
        assert response.status_code in [status.HTTP_303_SEE_OTHER, status.HTTP_403_FORBIDDEN]
...
class TestDownloadBackup:
    ...
    def test_professor_nao_pode_baixar_backup(self, professor_autenticado, criar_backup):
