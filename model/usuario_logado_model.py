...
class UsuarioLogado:
    ...
    def is_aluno(self) -> bool:
        ...
        return self.perfil == Perfil.ALUNO.value

    def is_professor(self) -> bool:
        """Verifica se o usuário é professor."""
        return self.perfil == Perfil.PROFESSOR.value
    ...
    def tem_perfil(self, *perfis: str) -> bool:
        ...
        Exemplo:
            if usuario.tem_perfil(Perfil.ADMIN.value, Perfil.PROFESSOR.value):
                # lógica para admin ou professor
        """
